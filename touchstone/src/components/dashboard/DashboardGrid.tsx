            ...
            <div className="flex gap-2">
              ...
              <div className="relative">
                <button
                  ...
                  className="add-widget-button flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-red-500 to-red-600  text-white rounded-lg hover:from-red-600 hover:to-red-700 transition-colors"
                >
