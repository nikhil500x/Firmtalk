            ...
            {/* <div className="flex items-center gap-4">
              {(activeTab === 'contacts' || activeTab === 'clients') && (
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-3 bg-gradient-to-b from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 transition-colors shadow-sm"
                >
                  <Plus size={20} />
