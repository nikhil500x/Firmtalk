          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-gradient-to-b from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 transition-colors"
              >
                <Lock size={16} />
                Change Password
              </button>
